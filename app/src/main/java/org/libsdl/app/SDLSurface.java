...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    // Aurora (lib/window.cpp) gates presenting/rendering on this flag; without
    // the call the guest parks in SDL_WaitEvent and the screen stays black.
    public static native void auroraNativeSetSurfaceReady(boolean ready);
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        try { auroraNativeSetSurfaceReady(false); } catch (Throwable ignored) {}
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        try { auroraNativeSetSurfaceReady(true); } catch (Throwable ignored) {}
